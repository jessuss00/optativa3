...
//	Obtener las tareas completadas.
	...
	public List<Tarea> findAllByUser() {
		return this.tareaRepository.findByUsuarioUsername(SecurityContextHolder.getContext().getAuthentication().getName());
	}
	...
	public Tarea findByIdAndUser(int idTarea) {
		...
		if(!t.getUsuario().getUsername().equals(SecurityContextHolder.getContext().getAuthentication().getName())) {
			throw new TareaSecurityException("La tarea con id " + idTarea + " no pertenece al usuario. ");
		}
